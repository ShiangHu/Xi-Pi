...
%             firstTime = isempty(remove);
        ...
        function addTitle(ax, varargin)
            ...
            p.addParameter('HorizontalAlignment', ax.axh.TitleHorizontalAlignment, @ischar);
...
%             ax.addAnchor(ai);
        ...
        function [hlist] = addTickBridge(ax, varargin)
            ...
            p.addParameter('bridgeLabelFontWeight', 'normal', @ischar);
...
%             % anchor marker width
        ...
        function hlist = addScaleBar(ax, varargin)
            ...
            p.addParameter('textAlign', '', @ischar);
        ...
        function [hl, ht] = addLabeledSpan(ax, varargin)
            ...
            p.addParameter('aggregate_label', {}, @ischar);
            ...
            p.addParameter('interpreter', 'none', @ischar);
...
%             ax.addHandlesToCollection('generated', hvec);
        ...
        function hout = addColorbar(ax, varargin)
            ...
            p.addParameter('tickLabels', [], @(x) isempty(x) || ischar(x));
            ...
            p.addParameter('labelBelow', '', @ischar); % used to describe the lower limit
            ...
            p.addParameter('labelAbove', '', @ischar); % used to describe the upper limit; 
            ...
            p.addParameter('labelCenterOtherSide', '', @(x) ischar(x) || isscalar(x));
            ...
            p.addParameter('labelLeftOtherSide', '', @(x) ischar(x) || isscalar(x));
            ...
            p.addParameter('labelRightOtherSide', '', @(x) ischar(x) || isscalar(x));
